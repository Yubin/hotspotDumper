...
'http://v4.jiwire.com/ve-ajax-quadrant-query.htm?servername=v4.jiwire.com'.
'&location_type_id='.
'&provider_id='.
'&pay_free='.
'&upperLeftLatitude=30.179634661707006'.
'&upperLeftLongitude=116.10239982604982'.
'&lowerRightLatitude=30.12798026947444'.
'&lowerRightLongitude=116.15192413330078'.
'&w=552'.
'&h=671'.
'&z=14'
  );
