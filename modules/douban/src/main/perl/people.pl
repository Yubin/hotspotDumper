...
#######################  GET http://api.douban.com/people/{userID}/contacts?start-index=1&max-results=50
#######################  return XML  #######################
=p
<?xml version="1.0" encoding="UTF-8"?>
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:db="http://www.douban.com/xmlns/" xmlns:gd="http://schemas.google.com/g/2005" xmlns:openSearch="http://a9.com/-/spec/opensearchrss/1.0/" xmlns:opensearch="http://a9.com/-/spec/opensearchrss/1.0/">
	<title>hebby❤ 关注的人</title>
	<author>
	<link href="http://api.douban.com/people/50482132" rel="self"/>
	<link href="http://www.douban.com/people/50482132/" rel="alternate"/>
	<link href="http://img3.douban.com/icon/u50482132-2.jpg" rel="icon"/>
	<name>hebby❤</name>
	<uri>http://api.douban.com/people/50482132</uri>
	</author>
	<entry>
	<id>http://api.douban.com/people/47205146</id>
	<title>、蒼穹</title>
	<link href="http://api.douban.com/people/47205146" rel="self"/>
	<link href="http://www.douban.com/people/tadpole0720/" rel="alternate"/>
	<link href="http://img3.douban.com/icon/u47205146-14.jpg" rel="icon"/>
	<content>
	because                
	and   
	why
	</content>
	<db:signature>有背包在，我一個人旅行不孤獨</db:signature>
	<db:uid>tadpole0720</db:uid>
	<uri>http://api.douban.com/people/47205146</uri>
	</entry>
...
####################### GET http://api.douban.com/people/{userID}/reviews
####################### return XML 

####################### GET http://api.douban.com/people/{userID}/collection
##  var: cat=movie,music,book
##  var: tag=*
##  var: status=book:wish, reading, read  movie:wish, watched  tv:wish, watching, watched music:wish, listening, listened
##  var: start-index=*
##  var: max-results=*
##  var: updated-max=*
##  var: updated-min=*

####################### GET http://api.douban.com/people/3452640/miniblog
####################### GET http://api.douban.com/people/3452640/miniblog/contacts

####################### GET http://api.douban.com/people/3452640/events[/initiate,participate,wish]


####################### GET http://api.douban.com/people/{userID}/recommendations

####################### GET http://api.douban.com/people/{userID}/tags
##  var: cat=movie,music,book
