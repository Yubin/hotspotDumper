...
# ****    resource  *******
#######################  GET http://api.douban.com/[book,music,movie]/subjects?q=hebby&start-index=1&max-results=50&alt=json
#######################  GET http://api.douban.com/[book,music,movie]/subjects?tag=hebby&start-index=1&max-results=50&alt=json
#######################  return JSON #######################
=p
...
=cut
#######################  GET http://api.douban.com/[book,music,movie]/{id}  
